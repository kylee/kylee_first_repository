...
document.write('  <EMBED SRC="'+banner_url+'" name='+banner_objid+' type=application/x-shockwave-flash  SWLiveConnect=TRUE play=true loop=false menu=false WIDTH='+banner_width+' HEIGHT='+banner_height+' scale=showall quality=best salign=BR loop=true pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"></EMBED>\n');
